...
export default function DevInteractiveLessonPreview() {
        ...
        <div className="max-w-[780px] mx-auto flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-slate-500 font-semibold">Dev Preview · Gold Standard · {totalSteps} steps</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold px-2.5 py-1 rounded-lg bg-amber-50 text-amber-700 border border-amber-200">
              DEV PREVIEW
            </span>
            {xpEarned > 0 && (
