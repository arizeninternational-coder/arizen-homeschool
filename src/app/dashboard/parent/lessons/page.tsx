  ...
  return (
    <div style={{ minHeight: '100vh', background: colors.bg }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <p style={{ color: colors.textMuted, marginBottom: '2rem' }}>Browse lessons your children are working on.</p>
        <div style={{ ...ds.card, textAlign: 'center', padding: '3rem 2rem' }}>
          ...
          <p style={{ color: colors.textMuted, fontSize: '0.9375rem' }}>Lesson data will appear here when your children start learning.</p>
        </div>
      </div>
    </div>
  );
