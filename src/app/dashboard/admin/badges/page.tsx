    ...
    <div style={{ minHeight: '100vh', background: colors.bg }}>
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <div style={{ ...ds.card, textAlign: 'center', padding: '3rem 2rem' }}>
          ...
          <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: colors.text, marginBottom: '0.5rem' }}>Badge management coming soon</h3>
          <p style={{ color: colors.textMuted, fontSize: '0.9375rem', maxWidth: 400, margin: '0 auto' }}>This module is under development. Full badge CRUD functionality will be available here.</p>
        </div>
      </div>
    </div>
  );
