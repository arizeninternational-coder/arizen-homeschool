  ...
  return (
    <div style={{ minHeight: '100vh', background: colors.bg }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <p style={{ color: colors.textMuted, marginBottom: '2rem' }}>Your active and completed quests will appear here.</p>

        <div style={{ ...ds.card, textAlign: 'center', padding: '3rem 2rem' }}>
          <Target style={{ width: 48, height: 48, color: colors.primary, margin: '0 auto 1rem', opacity: 0.4 }} />
          <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: colors.text, marginBottom: '0.5rem' }}>No active quests</h3>
          <p style={{ color: colors.textMuted, fontSize: '0.9375rem', maxWidth: 400, margin: '0 auto' }}>
            Quests will appear here once available. Explore themes to discover new learning adventures.
          </p>
        </div>
      </div>
    </div>
