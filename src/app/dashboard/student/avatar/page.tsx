...
export default function AvatarPage() {
  return (
    <div className="space-y-6">
      <PageHeader title="My Avatar" subtitle="Customize your look" />
      <div className="rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 p-8 text-center">
        ...
        <p className="text-text-muted text-sm max-w-md mx-auto">Your avatar customizer is being built. Check back soon to personalize your look!</p>
      </div>
    </div>
  );
}
