  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-white/90 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-3 px-5 py-4">
        ...
        <div>
          <span className="font-extrabold text-lg text-text tracking-tight block leading-tight">Arizen</span>
          <span className="text-[10px] font-bold uppercase tracking-[0.12em] text-text-muted">Teacher</span>
        </div>
      </div>
      ...
      <div className="flex-1 lg:ml-[260px] flex flex-col min-h-screen">
        <header className="sticky top-0 z-30 h-14 bg-white/70 backdrop-blur-xl flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <span className="font-extrabold text-sm">Arizen Teacher</span>
          </div>
