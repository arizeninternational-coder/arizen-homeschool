...
function standardJourney(welcomeTitle, welcomeText, welcomeOwl, missionText, missionOwl,
  ...
  return [
    ...
    makeStep("connect", "In Real Life", connectQ, "Good thinking. Now let's connect this idea to something you might see in real life.", numericInteraction(connectQ, connectAns), materials),
    makeStep("example", "Worked Example", exampleText, exampleOwl, { type: "none" }, materials),
    makeStep("practice", "Practice Time", practiceQ, "Try this one on your own. Use what you learned in the example. You've got this!", numericInteraction(practiceQ, practiceAns), materials),
